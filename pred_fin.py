...
# signs = np.array(['goodbye', 'hi', 'you', 'me', 'thankyou', 'goodmorning'])

signs = np.array(['Come', 'Good', 'Happy', 'Home', 'I Love You', 'Sorry'])
    ...
    while cap.isOpened():
        for y in range(videos_pred):
            for f in range(frames):
                ...
                # cv2.imshow('ISLR Real-Time Prediction', i§
